...
import { SettingsDropdown } from "src/components/playground/SettingsDropdown";
...
export const PlaygroundHeader = ({
  ...
  return (
    <div
      className="glass-navbar flex gap-4 px-6 justify-between items-center shrink-0 fixed top-0 left-0 right-0 z-50 transition-all duration-300"
      style={{
        height: height + "px",
      }}
    >
